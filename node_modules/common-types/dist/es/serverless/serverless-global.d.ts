...
import { IArnStringReference, ICloudformationReference, IServerlessFunction } from "./serverless-function";
 ...
 */
export declare type YamlExpression<T extends string = string> = `$\{${string}${T}${string}\}`;
