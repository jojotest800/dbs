 ...
 */
export declare type ExifExtraneous<T extends object = {}> = {
    /** [ `0x0001` ] */
    InteropIndex: string;
 ...
 * can be found on all fields here: [EXIF Tags](https://exiftool.org/TagNames/EXIF.html)
 */
export declare type ExifDateTimeInfo<T extends object = {}> = {
    ModifyDate: string;
    OffsetTime: string;
 ...
 * can be found on all fields here: [EXIF Tags](https://exiftool.org/TagNames/EXIF.html)
 */
export declare type ExifAttributionInfo<T extends object = {}> = {
    Copyright: string;
...
export declare type ExifCameraInfo<T extends object = {}> = {
    Make: string;
    Model: string;
...
export declare type ExifPhotoContext<T extends object = {}> = {
 ...
 */
export declare type ExifGps<T extends object = {}> = {
    GPSVersionID: number;
    GPSLatitudeRef: "N" | "S";
    GPSLatitude: number;
    GPSLongitudeRef: "E" | "W";
 ...
 */
export declare type ExifMetadata<T extends object = {}> = Partial<ExifAttributionInfo & ExifCameraInfo & ExifDateTimeInfo & ExifGps & ExifExtraneous & ExifPhotoContext> & T;
