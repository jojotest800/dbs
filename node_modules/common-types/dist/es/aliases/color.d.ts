 ...
 */
export declare type RgbStrArray = [OptThreeDigit, OptThreeDigit, OptThreeDigit];
/**
 ...
 */
export declare type RgbStr = `{${OptSpace}r:${OptSpace}${OptThreeDigit},${OptSpace}g:${OptSpace}${string},${OptSpace}b:${OptSpace}${string}}`;
/**
 ...
 */
export declare type HexColor = `${Hexadecimal}${Hexadecimal}${Hexadecimal}${Hexadecimal}${string}`;
/**
 ...
 */
export declare type HtmlHexColor = `#${HexColor}`;
