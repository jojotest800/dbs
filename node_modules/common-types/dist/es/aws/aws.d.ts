 ...
 */
export declare type IAwsHandlerFunction<T, R = IDictionary, E = Error> = (event: IAwsLambdaEvent<T>, context: IAwsLambdaContext, 
/**
...
export declare type IAwsLambdaProxyIntegrationRequest = IAwsLambdaProxyIntegrationRequestV1 | IAwsLambdaProxyIntegrationRequestV2;
/**
