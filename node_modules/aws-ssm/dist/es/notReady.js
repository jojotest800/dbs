 ...
 */
export function notReady(name) {
    throw new SsmError("aws-ssm/not-ready", `You must set an environment "stage" before using the SSM api. To do this, set either AWS_STAGE or NODE_ENV.\n  Alternatively you can pass in { nonStandardPath: true } to the options property of get(), set(), list(), or delete().`);
}
