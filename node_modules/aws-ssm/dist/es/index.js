...
import { coerceValueToString, findPriorDescription, getLatestVersion, addModuleName, getSpecificVersion } from "./utils";
    ...
    async modules(mods, options = {}) {
        ...
        return mods.reduce((prev, mod) => {
            return Object.assign(Object.assign({}, prev), {
                [mod]: options.version
                    ? addModuleName(mod, getSpecificVersion(intermediate[mod], options.version, options.verbose), options.verbose)
                    : addModuleName(mod, getLatestVersion(intermediate[mod], options.verbose), options.verbose)
            });
        }, {});
    }
...
export function buildPathFromNameComponents(parts) {
