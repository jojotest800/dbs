 ...
 */
export function parseForNameComponents(inputPath, ignoreNonStandardPaths = false) {
    ...
    if (numOfParts === 2) {
        ...
        throw new SsmError(`aws-ssm/invalid-format`, `The "name" in an SSM parameter can be a simple string (aka, FOO) or a shorthand notation (aka, firebase/FOO) or a fully qualified notation (aka., test/1/firebase/FOO) but the passed in name -- ${inputPath} -- was not recognized as any of these formats.`);
    }
}
